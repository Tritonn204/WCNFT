...
contract WarToken is ERC20, ERC20Burnable, ERC20Snapshot, AccessControl, ERC20Permit {
    bytes32 public constant DEV_ROLE = keccak256("DEV_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    constructor() ERC20("War Token", "WAR") ERC20Permit("War Token") {
        _setupDecimals(18);
    ...
    function addMinter(address newMinter) public onlyRole(DEV_ROLE) {
        _grantRole(MINTER_ROLE, newMinter);
    }

    function removeMinter(address minter) public onlyRole(DEV_ROLE) {
        _revokeRole(MINTER_ROLE, minter);
    }

    function snapshot() public onlyRole(DEV_ROLE) {
        _snapshot();
    }
